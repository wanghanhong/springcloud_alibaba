package com.smart.common.redis.aspect;


import com.smart.common.redis.annotation.RedisCache;
...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.smart.common.redis.annotation.RedisCache)")
     ...
     */
    @Pointcut("@annotation(com.smart.common.redis.annotation.RedisEvict)")
