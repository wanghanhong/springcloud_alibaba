...
import com.smart.common.log.annotation.OperLog;
import com.smart.common.log.enums.BusinessStatus;
...
public class OperLogAspect {
    // 配置织入点
    @Pointcut("@annotation(com.smart.common.log.annotation.OperLog)")
