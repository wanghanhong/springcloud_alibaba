package com.smart.gateway.aspect;
...
public class UserIdAdvice {
     ...
     * 切入点，定义所有的控制器
     */
    @Pointcut("execution(public * com.smart.device.access.controller.*.*(..)) || execution(public * com.smart.device.install.controller.*.*(..)) || " +
            "execution(public * com.smart.device.message.data.controller.*.*(..)) ")
