package com.smart.gateway.brd.filter;
...
public class AuthFilter implements GlobalFilter, Ordered {
     ...
     * swagger排除自行添加
     */
    private static final String[] whiteList = {"/auth/login", "/user/register","/test/v2/api-docs", "/test/getMyProperties"};
    ...
    private Mono<Void> setUnauthorizedResponse(ServerWebExchange exchange, String msg) {
        ...
        try {
            ...
            response = mapper.writeValueAsString(R.error(401, msg)).getBytes(Constants.UTF8);
