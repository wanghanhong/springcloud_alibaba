package com.smart.message.manage.common.utils;
...
public class DateUtil {
    ...
    public static String getSig(String accountid, String token, String yyyy) {
        String str = accountid + token + getyyyy();
        String md5DigestAsHex = DigestUtils.md5DigestAsHex(str.getBytes()).toUpperCase();
    ...
    public static String dateToStringParam(Date date, String dateFormatType) {
