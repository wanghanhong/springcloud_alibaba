...
public class Wlnb3011Standard {
     ...
     * @return
     */
    public TAlarmSmoke changeToAlarm(Wlnb3011Entity vo) {
        ...
        log.info("万林nb3011-标准化为数据库报警表" + JSONObject.toJSONString(alarm));
        return alarm;
    }

    public THeartSmoke changeToHeart(Wlnb3011Entity vo) {
        ...
        log.info("万林3011-标准化为数据库心跳日志表" + JSONObject.toJSONString(heart));
        return heart;
    }
    ...
    public static void main(String[] args) {
        ...
        Wlnb3011ParseStrategy strategy = new Wlnb3011ParseStrategy();
        Wlnb3011Entity e = strategy.assemblyData(data);
        Wlnb3011Standard pressureStandar = new Wlnb3011Standard();
