...
import com.smart.device.message.parse.fire.liquidlevel.wanlin.strategy.LiquidlevelParseStrategy;
import com.smart.device.message.parse.fire.liquidlevel.wanlin.strategy.LiquidlevelStandar;
 ...
 */
@Service
public class LiquidlevelParse implements FireDeviceParse {

    @Resource
    private LiquidlevelParseStrategy liquidlevelParseStrategy;
    @Resource
    private LiquidlevelStandar liquidlevelStandar;
    @Resource
    private TAlarmWaterpressService tAlarmLiquidlevelService;
    @Resource
    private THeartWaterpressService tHeartLiquidlevelService;
    @Resource
    ...
    public String parse(String data) {
        ParseContext<PressureEntity> context = new ParseContext<>(liquidlevelParseStrategy);
        PressureEntity entity = context.parseEntity(data);
        TAlarmWaterpress alarm = liquidlevelStandar.changeToAlarm(entity);
        THeartWaterpress heart = liquidlevelStandar.changeToTHeart(entity);
            ...
            if (exist  !=null && "1".equals(exist)){
                ...
                if(baseVo != null){
                    ...
                    if(strategyAlarm != null && strategyAlarm.getStrategyType() >= 0){
                        ...
                        tAlarmLiquidlevelService.waterpressAdd(alarm);
                        // 报警才有策略，心跳直接跳过。
                    ...
                    tHeartLiquidlevelService.waterpressAdd(heart);
                }
