...
public class WaterStandar {
     ...
     */
    public TAlarmWaterpress changeToAlarm(WaterEntityVo vo) {
        ...
        //设备故障码
        alarm.setContent(WaterMapConstant.HQ_MAP.get(WaterEnum.ALERT).get(String.valueOf(vo.getAlert())));
        ...
        log.info("ctwing华强消防栓水压-标准化为数据库报警表" + JSONObject.toJSONString(alarm));
        return alarm;
    }

    public THeartWaterpress changeToTHeart(WaterEntityVo vo) {
        ...
        heart.setWpdata1(vo.getWpData1()== null?null:vo.getWpData1().floatValue());
        heart.setWptime1(DateUtils.covertTimeStringToLocalDateTime(vo.getWpTime2()));
        heart.setWpdata2(vo.getWpData2()== null?null:vo.getWpData2().floatValue());
        heart.setWptime2(DateUtils.covertTimeStringToLocalDateTime(vo.getWpTime2()));
        heart.setWpdata3(vo.getWpData3()== null?null:vo.getWpData2().floatValue());
        heart.setWptime3(DateUtils.covertTimeStringToLocalDateTime(vo.getWpTime2()));
        heart.setWpdata4(vo.getWpData4()== null?null:vo.getWpData2().floatValue());
        heart.setWptime4(DateUtils.covertTimeStringToLocalDateTime(vo.getWpTime2()));

        if(vo.getWpSon() != null){
            heart.setWpSon(vo.getWpSon());
        }

        // TODO: 2020/5/11 需要写入数据库的
        log.info("ctwing华强消防栓水压-标准化为数据库心跳日志表" + JSONObject.toJSONString(heart));
        return heart;
