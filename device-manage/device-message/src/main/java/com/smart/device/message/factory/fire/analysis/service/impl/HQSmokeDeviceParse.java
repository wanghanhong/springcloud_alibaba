...
import com.smart.device.message.parse.fire.smoke.huaqiang.strategy.HQSmokeParseStrategy;
import com.smart.device.message.parse.fire.smoke.huaqiang.strategy.HQSmokeStandar;
 ...
 */
@Service
public class HQSmokeDeviceParse implements FireDeviceParse {

    @Autowired
    private HQSmokeParseStrategy smokeParseStrategy;
    @Autowired
    private HQSmokeStandar huqQiangStandarStrategy;
    @Resource
    ...
    public String parse(String data) {
        ParseContext<DeviceEntity> context = new ParseContext<>(smokeParseStrategy);
        DeviceEntity entity = context.parseEntity(data);
        DeviceEntityVo deviceEntityVo = smokeParseStrategy.convertVo(entity);

        TAlarmSmoke alarm = huqQiangStandarStrategy.changeToAlarm(deviceEntityVo);
        THeartSmoke heart = huqQiangStandarStrategy.changeToHeart(deviceEntityVo);
