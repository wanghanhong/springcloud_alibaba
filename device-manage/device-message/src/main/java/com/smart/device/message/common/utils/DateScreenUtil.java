...
public class DateScreenUtil {
    ...
    public static String formatCSTTime(String date, String format) throws ParseException {
        ...
        return DateScreenUtil.getDateFormat(d, format);
    }
     ...
     * @return
     */
    private List<Map<String, Object>> initialMonthList(int start) {
        ...
        for (int i = start; i < start + 12; i++) {
            String date = firstday.plusMonths(i).format(formatter);;
            map = new HashMap();
            map.put("time", date);
            map.put("num", 0);
            list.add(map);
    ...
    public List<Map<String, Object>> changeMonthList(List<Map<String, Object>> list) {
        List<Map<String, Object>> res = initialMonthList(0);
        res.forEach(e -> {
            String outDate = String.valueOf(e.get("time"));
            list.forEach(map -> {
                String inDate = String.valueOf(map.get("time"));
    ...
    public static void main(String[] args) {
     /*   Calendar calendar = Calendar.getInstance();
        ...
        DateScreenUtil DateUtil = new DateScreenUtil();
