 ...
 */
@Data
public class WaterEntity extends DeviceBaseInfo {
    ...
    /**
     * 采集间隔时间值 时间单位 x 时间值表示采集时间，如 2 小时，
     * 0x0202，0 表示不设置
     */
    ...
    /**
     * 上传间隔时间值 时间单位 x 时间值表示采集时间，如 2 小时，
     * 0x0202
     */
     ...
     */
    private Integer wplowThd;
    /**
     * 设备水压低压报     * 警门限
     * 数值范围 0~2.5mpa，单位 kpa，如 1Mpa 水压，
     * 为 1000kpa,表示为 0x000003E8
     */
    private Integer wphighThd;

    private long reserve;

    /**
     * 水压数据包数量 数值范围 0~48，表示本包数据包含的有效水压数
     * 据量
     */
