...
@TableName("t_alarm_liquidlevel")
@ApiModel(value = "TAlarmLiquidlevel对象", description = "电力设备警报")
public class TAlarmLiquidlevel implements Serializable {
    ...
    @ApiModelProperty(value = "2电量不足3低水位报警13低水位报警恢复4高水位报警14高水位报警恢")
