...
@TableName("t_alarm_smoke")
@ApiModel(value = "TAlarmSmoke对象", description = "烟感设备警报")
public class TAlarmSmoke implements Serializable {
    ...
    @ApiModelProperty(value = "警报类型1火灾报警2故障3欠压告警4拆卸9复位,解除报警")
