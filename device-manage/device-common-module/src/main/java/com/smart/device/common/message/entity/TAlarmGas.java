...
@TableName("t_alarm_gas")
@ApiModel(value = "TAlarmGas对象", description = "电力设备警报")
public class TAlarmGas implements Serializable {
    ...
    @ApiModelProperty(value = "1报警2故障3机械手控制9复位")
