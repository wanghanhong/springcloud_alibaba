...
@TableName("t_alarm_firehost")
@ApiModel(value = "TAlarmFirehost对象", description = "电力设备警报")
public class TAlarmFirehost implements Serializable {
    ...
    @ApiModelProperty(value = "1报警2故障9复位")
