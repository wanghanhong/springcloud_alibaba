package com.smart.brd.manage.base.common;
...
public class RestTemplateConfiguretion {
    private static final Logger logger = LoggerFactory.getLogger(RestTemplateConfiguretion.class);
    ...
    class ClientHttpsRequestFactory extends SimpleClientHttpRequestFactory {
        ...
        private class SkipHostnameVerifier implements HostnameVerifier {
            ...
            public boolean verify(String requestedHost, SSLSession remoteServerSession) {
                logger.info(requestedHost);
                logger.info("+++++++++++++++++++++++++++");
                logger.info(remoteServerSession.getPeerHost());
                logger.info("+++++++++++++++++++++++++++++");
                String s = String.valueOf(requestedHost.equalsIgnoreCase(remoteServerSession.getPeerHost()));
                logger.info(s);
