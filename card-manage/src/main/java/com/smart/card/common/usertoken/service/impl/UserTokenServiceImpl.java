package com.smart.card.common.usertoken.service.impl;
...
import com.smart.card.common.usertoken.service.UserTokenService;
        ...
        try {
            if(StringUtils.isNotBlank(token)){
                ...
                if(StringUtils.isNotBlank(tokenStr)){
                    ...
                    Claim parentId = jwt.getClaim("parentId");
                    ...
                    if(parentId != null){
                        user.setParentId(parentId.asLong());
                    }
